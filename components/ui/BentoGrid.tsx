    ...
    >
      ...
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        >
          ...
          {/* remove mb-2 mt-2 */}
          <div className={`font-sans text-lg lg:text-3xl md:max-w-96 font-bold z-50`}>
            {title}
          </div>
          <div className="font-sans font-extralight md:max-w-96 md:text-xs lg:text-base text-sm text-[#C1C2D3] z-50">
            {description}
          </div>
